...
@section('title', 'Tambah Master Bahan Baku - Cocofarma')
...
<div class="container">
    <div class="page-header">
        <h1><i class="fas fa-plus"></i> Tambah Master Bahan Baku</h1>
    ...
    <form class="form-container" action="{{ route('backoffice.master-bahan.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Deskripsi master bahan baku (opsional)">{{ old('deskripsi') }}</textarea>
            @error('deskripsi')
                <span class="text-danger" data-server-error="true">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save"></i> Simpan Master Bahan
            </button>
        </div>
    </form>
</div>

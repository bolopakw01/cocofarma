...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.initBolopaExportPrint({
            ...
            filenamePrefix: 'produksi',
            printedBy: '{{ auth()->user()->name ?? 'Administrator' }}',
            printBrandTitle: 'Cocofarma — Produksi',
            printBrandSubtitle: 'Daftar batch produksi',
            printNotes: 'Catatan: Kolom aksi dihilangkan saat cetak untuk menjaga keterbacaan.',
            totalLabel: 'Total Produksi',
            notify: notify,
            messages: {
                exportSuccess: 'Data produksi berhasil diekspor.',
                exportError: 'Gagal export data produksi.',
